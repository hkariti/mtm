...
bool testCreatePokemonGo() {
	...
	// Invalid inputs
	pokemonGo = createPokemonGo(NULL, NULL, NULL, NULL);
	ASSERT_TEST(NULL == pokemonGo);
	pokemonGo = createPokemonGo(NULL, evolutions, locations, stdout);
	ASSERT_TEST(NULL == pokemonGo);
	pokemonGo = createPokemonGo(pokedex, NULL, locations, stdout);
	ASSERT_TEST(NULL == pokemonGo);
	pokemonGo = createPokemonGo(pokedex, evolutions, NULL, stdout);
	ASSERT_TEST(NULL == pokemonGo);
	pokemonGo = createPokemonGo(pokedex, evolutions, locations, NULL);
	ASSERT_TEST(NULL == pokemonGo);

	// Valid inputs
	pokemonGo = createPokemonGo(pokedex, evolutions, locations, stdout);
...
bool testDestroyPokemonGo() {
	...
	// Valid input
	PokemonGo pokemonGo = createPokemonGo(pokedex, evolutions, locations, stdout);
	pokemongoDestroy(pokemonGo);
